...
public class SentToGoogle
{
    ...
    [SerializeField] private string URL3 = "https://docs.google.com/forms/u/0/d/e/1FAIpQLScC-ItNJBIiz8qOD-bbL0dWcqIGQa_6YW0Fnz84anX2L1xNMg/formResponse";
    ...
    public IEnumerator Post3(string level, string totalTimeTaken) // string level, string session
    {
        WWWForm form = new WWWForm();
