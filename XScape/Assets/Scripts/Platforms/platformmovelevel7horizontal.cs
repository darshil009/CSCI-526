...
public class platformmovelevel7horizontal : MonoBehaviour
{
  [Header(
  ...
  public int checkhorizontalplatform7 = 0;
  ...
  {
      if (FindObjectOfType<platformmovelevel7vertical>().returnverticalplatformmoving7()==0) {
        ...
        if (checkhorizontalplatform7==0){
          checkhorizontalplatform7 = 1;
        }
        else {
          checkhorizontalplatform7 = 0;
        }
        _timeElapsed = 0;
  ...
  public int returnhorizontalplatform7() {
    return checkhorizontalplatform7;
  }
}
